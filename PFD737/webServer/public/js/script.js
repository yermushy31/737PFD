...
class CanvasIndicator {
    ...
    rightAltitude(value, range, graduation) {
        ...
        const spacing = this.#canvas.height / (range * 0.34 / graduation); // Adjust spacing based on range and graduation
    ...
    altitudeMarker(altitude, range) {
        ...
        this.#context.fillText(altitude, this.#canvas.width * 0.3, centerY + 7);
    }
